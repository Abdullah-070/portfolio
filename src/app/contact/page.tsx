...
export const metadata: Metadata = {
  title: "Contact | Abdullah - Software Developer",
  description:
    "Get in touch with Abdullah for Software development projects, collaborations, and job opportunities.",
  keywords: [
    "Contact Abdullah",
  ...
  openGraph: {
    ...
    title: "Contact | Abdullah - Software Developer",
    description:
      "Get in touch with Abdullah for web development projects, collaborations, and job opportunities.",
  },
  twitter: {
    images: "https://i.ibb.co/20FD61NY/image.png",
    title: "Contact | Abdullah - Software Developer",
  ...
  return (
    <main className="flex-none h-auto px-4 md:px-8 lg:px-28 relative w-[100%] m-auto">
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-primary-300 rounded-full opacity-20 animate-pulse delay-500"></div>
        ...
        <div className="relative z-10">
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="text-center lg:text-left lg:w-1/2 space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-7xl md:text-6xl font-bold leading-tight animate-fade-in-up">
                  <span className="text-primary-600 animate-fade-in-up delay-200">
                    Get In
                  </span>
                  {" "}
                  ...
                  <span className="text-primary-600 animate-fade-in-up delay-400">
                    .
                  </span>
                </h1>
              </div>
              ...
              <div className="space-y-4 animate-fade-in-up delay-700">
                {/* Email */}
                <Link
                  href="mailto:m.abdullahazhar070@gmail.com"
                  className="group flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:border-primary-200"
                >
            ...
            <div className="relative flex items-center justify-center w-72 md:w-80 lg:w-96 h-72 md:h-80 lg:h-96 animate-fade-in-up delay-300">
              ...
              <div className="relative w-full h-full rounded-full border-4 border-primary-300 shadow-xl overflow-hidden">
                <Image
                  src={profileImg}
                  alt="Muhammad Abdullah - Frontend Developer"
                ...
                <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-primary-400 rounded-full animate-bounce delay-1500"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary-50 to-gray-50 rounded-2xl p-8 lg:p-12 border border-primary-100">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="mailto:m.abdullahazhar070@gmail.com"
                className="group px-8 py-4 bg-primary-600 text-white rounded-xl hover:bg-primary-700 font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
              >
                <Send className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
                Send Message
              </Link>
              <Link
                href="resume-m-abdullah.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="group px-8 py-4 bg-transparent border-2 border-primary-600 text-primary-600 rounded-xl hover:bg-primary-600 hover:text-white font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 justify-center"
              >
                Download Resume
              </Link>
            </div>
