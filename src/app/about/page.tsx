...
export const metadata: Metadata = {
  title: "About | Muhammad Abdullah - Software Developer",
  description:
    "Learn more about Muhammad Abdullah, a software developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
  ...
  return (
    <main className="flex-none h-auto px-4 md:px-8 lg:px-28 relative w-[100%] m-auto">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-primary-light rounded-full opacity-20 animate-pulse delay-500"></div>

        <div className="relative z-10">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h1 className="text-4xl lg:text-7xl md:text-6xl font-bold text-gray-800 mb-6 animate-fade-in-up">
              About me<span className="text-primary-600">.</span>
            </h1>
            <p className="text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto animate-fade-in-up delay-200 border-l-4 lg:border-l-8 border-primary-600 pl-6 lg:pl-8">
          ...
          {/* Mission Statement */}
          <div className="bg-gradient-to-r from-primary-50 to-gray-50 rounded-2xl p-8 lg:p-12 border border-primary-100 animate-fade-in-up delay-700">
