...
export const metadata: Metadata = {
  title: "Projects | Muhammad Abdullah - Software Developer",
  description:
    "Explore projects developed by Muhammad Abdullah, a software developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
  ...
  return (
    <main className="flex-none h-auto px-4 md:px-8 lg:px-28 relative w-[100%] m-auto">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-10 w-20 h-20 bg-primary-200 rounded-full opacity-30 animate-pulse delay-1000"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl lg:text-7xl md:text-6xl font-bold text-gray-800">
                My <span className="text-primary-600">Best</span> Creations
              </h1>
            </div>
          </div>
          ...
          <div className="max-w-4xl">
            <p className="text-gray-800 text-xl lg:text-2xl px-2 border-l-4 lg:border-l-8 border-primary-600 mb-8">
        ...
        <div className="bg-gradient-to-r from-primary-50 to-gray-50 rounded-2xl p-8 lg:p-12 border border-primary-100">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="mt-8 p-4 bg-white rounded-lg border-l-4 border-primary-600">
